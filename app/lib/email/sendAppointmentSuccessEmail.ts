...
export async function sendAppointmentSuccessEmail(client: User, appt: Appointment) {
    ...
    await transporter.sendMail({
        ...
        html: `
            ...
            <p>If you are unable to make it to the appointment at the set time, you can reschedule it here <strong>${process.env.NEXT_PUBLIC_BASE_URL}/home/appointments/reschedule?id=${appt.id}</strong></p> 
            <p>Best regards,</p>
